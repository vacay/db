...
VALUES
	(1, 't3rr0r', 't3rr0r', '$2a$08$00Gw2mtaDwwqq5onC7i2WeeVP/d/dLX4C0Wcdj5rTI1ZXHl.6FG5a', 't3rr0r@email.com', null, null, 'A short bio', 'Your location', 1, NOW(), NOW(), NOW());

INSERT INTO `users` (`id`, `name`, `username`, `password`, `email`, `avatar`, `cover`, `bio`, `location`, `notification`, `last_visit`, `created_at`, `updated_at`)
VALUES
	(2, 'Mistakia', 'mistakia', '$2a$08$00Gw2mtaDwwqq5onC7i2WeeVP/d/dLX4C0Wcdj5rTI1ZXHl.6FG5a', 'mistakia@mail.com', null, null, 'A short bio', 'Your location', 1, NOW(), NOW(), NOW());
